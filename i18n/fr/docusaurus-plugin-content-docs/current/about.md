...
**Structus** est une bibliothèque open-source axée sur l'implémentation des principes d'architecture propre en Kotlin.

### Contact

- 🐙 **GitHub**: [structus-kotlin](https://github.com/structus-io/structus-kotlin)
- 💼 **Documentation**: [structus-kotlin.github.io](https://structus-io.github.io/structus-docs/)
...
- **Herberto Graça** - [Architecture Explicite](https://herbertograca.com/2017/11/16/explicit-architecture-01-ddd-hexagonal-onion-clean-cqrs-how-i-put-it-all-together/)
...
Consultez le [Guide de contribution](https://github.com/structus-io/structus-kotlin/blob/main/CONTRIBUTING.md) pour plus de détails.

## Licence

Structus est un logiciel open-source sous licence [MIT License](https://github.com/structus-io/structus-kotlin/blob/main/LICENSE).
...
**Fait avec ❤️ pour la communauté Kotlin**